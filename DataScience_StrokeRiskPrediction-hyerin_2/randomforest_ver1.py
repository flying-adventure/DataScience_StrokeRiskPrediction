...
def stroke_prediction_pipeline_random_v1(df):
    df = df.copy()
# ------------------------------
# 1. 데이터 로딩 및 초기 탐색
# ------------------------------
df = pd.read_csv(r"C:\Users\heejin\Downloads\DataScience_StrokeRiskPrediction-hyerin_2\healthcare-dataset-stroke-data.csv")
print("원본 데이터셋:")
print(df.head())
print("\n기본 정보:")
print(df.info())
